...
(function () {
    ...
    function findJobCards() {
        ...
        for (const card of cards) {
            ...
            const alreadyAppliedText = (_a = appliedFeedback === null || appliedFeedback === void 0 ? void 0 : appliedFeedback.textContent) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes('applied');
            ...
            validCards.push({
                ...
                title: ((_b = clickableElement === null || clickableElement === void 0 ? void 0 : clickableElement.textContent) === null || _b === void 0 ? void 0 : _b.trim()) || 'Untitled Position'
            });
        }
        log(`Found ${validCards.length} job cards to process`);
        return validCards;
    }
    function openJobCard(jobCard, index) {
    ...
    function processJobApplication(jobData, index) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const jobDetails = yield waitForElement(`${config.jobDetailsPanel} ${config.jobDetailsContent}`, 10000);
                if (!jobDetails) {
                ...
                const applicationComplete = yield new Promise((resolve) => {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const selector of closeSelectors) {
                ...
                for (const button of Array.from(buttons)) {
                    try {
                        if (button.offsetParent !== null && ((_a = button.textContent) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes('close'))) {
    ...
    function applyIfEasyApplyVisible() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (const selector of nextButtonSelectors) {
                    ...
                    if (nextButton && !nextButton.disabled) {
                        ...
                        yield delay(1000); // Slightly longer delay for better reliability
                        nextButton.click();
                        yield delay(4000); // Wait for page to load
                        return true;
                    }
                }
    ...
    function processAllJobs() {
        return __awaiter(this, arguments, void 0, function* (pageNumber = 1) {
                ...
                while (currentIndex < jobsToProcess &&
                    ...
                    if (currentIndex >= 0 && currentIndex < jobCards.length) {
                        ...
                        try {
                            ...
                            const success = yield processJobApplication(jobCard, currentIndex);
                            if (success) {
                                totalApplications++;
                                successfulApplications++;
                        ...
                        if (jobsAttemptedOnPage >= jobsBeforePageChange && !stopProcessing) {
                            ...
                            yield closeAllModals();
                            yield delay(1000);
                            const success = yield goToNextPage();
                            if (success) {
                                yield delay(3000);
                                isProcessing = false;
                                yield processAllJobs(pageNumber + 1);
                                return true;
                            }
                            else {
                        ...
                        if (jobsProcessedOnPage === 0) {
                            ...
                            const hasNextPage = yield goToNextPage();
                            if (hasNextPage) {
                                yield delay(3000);
                                isProcessing = false;
                                yield processAllJobs(pageNumber + 1);
...
//# sourceMappingURL=BatchApply.js.map